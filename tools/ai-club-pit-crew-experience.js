...
// ── Full arena mission system (ported from ai-club-scavengers.js) ─────────
...
function buildArenaRobot(scene) {
  ...
  // Scout legs — 4 articulated leg groups
  const legs = [];
